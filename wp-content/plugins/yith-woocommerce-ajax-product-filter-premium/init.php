...
$notice = Code8_Admin_Notices::get_instance('yith-woo-ajax-product-filter-pro-ir');
$notice->error( '<h2>تذکر مهم</h2>' .'<p>افزونه  YITH WooCommerce Ajax Product Filter Premiumتوسط سایت لرن دی ال learndl.ir تهیه و بومی سازی شده است،اگر شما این افزونه را از سایتی غیر از سایت لرن دی ال تهیه کرده باشید،به صورت غیرقانونی به دست شما رسیده و باید به سایت لرن دی ال مراجعه کنید و گزارش دهید</p>', true  );