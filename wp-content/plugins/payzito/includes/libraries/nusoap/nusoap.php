		            ...
		            foreach ($xs->imports as $ns2 => $list2) {
		                for ($ii = 0; $ii < count($list2); $ii++) {
		                	if (! $list2[$ii]['loaded']) {
                                ...
                                // یک مشکلی در نوین پرداخت داریم که میخواد این متغیر رو ست کنه و خطا میگیره
                                // این شرط برای اون ست شده و در آپدیت ها باید این لحاظ بشه
                                if($this->schemas[$ns]->imports && is_array($this->schemas[$ns]->imports))
                                {
