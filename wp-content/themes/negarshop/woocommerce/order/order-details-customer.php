...
<section class="woocommerce-customer-details">
    ...
    <section class="woocommerce-columns woocommerce-columns--2 woocommerce-columns--addresses col2-set addresses row">
        <div class="woocommerce-column woocommerce-column--1 woocommerce-column--billing-address col">
            ...
            <address>
                <?php echo str_replace('<br />', ' ، ', wp_kses_post($order->get_formatted_billing_address(esc_html__('N/A', 'woocommerce')))); ?>
        ...
        <div class="woocommerce-column woocommerce-column--2 woocommerce-column--shipping-address col">
            ...
            <address>
                <?php echo str_replace('<br />', ' ، ', wp_kses_post($order->get_formatted_shipping_address(__('N/A', 'woocommerce')))); ?>
