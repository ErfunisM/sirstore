...
<form class="cart grouped_form"
    ...
    <table cellspacing="0" class="woocommerce-grouped-product-list group_table w-100">
        <tbody>
        <?php
        ...
        foreach ($grouped_products as $grouped_product_child) {
            ...
            negarshop_remove_array_element($grouped_product_columns, 0, 1);
            // Output columns for each product.
            $sort = ["label", "price", "quantity"];
            foreach ($sort as $column_id) {
                ...
                switch ($column_id) {
                    case 'quantity':
                        ...
                        break;
                    case 'label':
                        $value = '<label style="text-align: right;display: block;padding: 0 5px;" for="product-' . esc_attr($grouped_product_child->get_id()) . '">';
    ...
    <?php if ($quantites_required && $show_add_to_cart_button) : ?>
        <div class="product-add-cart-form-button">

            <?php do_action('woocommerce_before_add_to_cart_product_actions');
            do_action('woocommerce_before_add_to_cart_button'); ?>

            <button type="submit"
                    class="single_add_to_cart_button button alt btn btn-primary"><?php echo esc_html($product->single_add_to_cart_text()); ?></button>
            <div class="clear"></div>
