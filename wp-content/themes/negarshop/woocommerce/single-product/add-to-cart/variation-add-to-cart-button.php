...
global $product;
?>
<div class="woocommerce-variation-add-to-cart variations_button mt-3 product-add-cart-form-button">
	<?php
    ...
    do_action( 'woocommerce_before_add_to_cart_product_actions' ); ?>
        <div class="ns-add-to-cart-inner clearfix">
            ...
            <button type="submit" class="single_add_to_cart_button button alt btn btn-primary">
	            <?php do_action( 'ns_custom_add_to_cart_btn' ); ?>
