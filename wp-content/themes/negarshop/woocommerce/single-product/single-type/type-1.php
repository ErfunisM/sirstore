...
$actionsPosition = $type_picker['actions_position'];
?>
    <div class="product-section">
        <div class="row">
            <div class="col-lg-4">
                <?php if ($actionsPosition === 'thumbnail' && negarshop_option('product_tools_ac') == "true") {
            ...
            <div class="col-lg">
                ...
                <div class="row">
                    ...
                    echo $product->get_type() == "grouped" ? "-12" : ""; ?>">
                        <?php
                        if ($actionsPosition === 'cart' && negarshop_option('product_tools_ac') == "true") {
                            wc_get_template_part('single-product/product', 'actions');
                        }
                        ?>
                        <div class="product-summary-left not-sticky product-summary-left--<?php echo esc_attr($type_picker['cart_style']); ?> <?php echo negarshop_option('product_responsive_add_to_cart') === 'true' ? '' : 'inline-mode'; ?>">
